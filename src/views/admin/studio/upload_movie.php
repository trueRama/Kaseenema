        ...
        <div class="modal-content">
            <div class="card card-rounded">
                <div class="card-header">
                    ...
                    <a href="assets/templates/movie.xlsx" class="btn btn-dark btn-rounded btn-fw">Download Template</a>
                </div>
                <div class="card-body">
                    <div class="row">
                        <form class="forms-sample row" method="post" enctype="multipart/form-data" action="/upload_movies">
